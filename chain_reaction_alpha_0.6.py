...
class Game:
    ...
    def check_winner(self) -> bool:
        ...
        # 1. There are dots on the board
        # 2. All dots are the same color
        # 3. At least one move has been made by each player
...
def draw_game(game: Game):
    ...
    if game.game_over:
        ...
        text = font.render(f"{winner_color} Võidab!", True, winner_text_color)
